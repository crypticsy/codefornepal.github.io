  ...
  return (
    <section id={timeline.section || 'about'} style={{ padding: '6rem 0', background: '#fff' }}>
      ...
      <style>{`
        ...
        .timeline-row-right .timeline-content { grid-column: 3; text-align: left; }
        .timeline-row-right .timeline-spacer { grid-column: 1; }
        .timeline-node { grid-column: 2; display: flex; justify-content: center; align-items: center; }
        .timeline-node-circle { width: 80px; height: 80px; border-radius: 50%; overflow: hidden; border: 4px solid #fff; box-shadow: 0 0 0 2px #dc2626; background: #fff; display: flex; align-items: center; justify-content: center; }
        .timeline-node-circle img { width: 100%; height: 100%; object-fit: cover; }
        .timeline-node-icon { color: #dc2626; font-size: 1.25rem; }
        .timeline-content-card { padding: 1.5rem; background: #f9fafb; border: 1px solid #f3f4f6; border-radius: 8px; display: inline-block; text-align: left; max-width: 100%; box-sizing: border-box; }
        .timeline-row-left .timeline-content-card { text-align: left; }
        .timeline-row-right .timeline-content-card { text-align: left; }
        ...
        @media (max-width: 768px) {
          ...
          .timeline-row-left .timeline-content, .timeline-row-right .timeline-content { grid-column: 2 !important; text-align: left !important; }
